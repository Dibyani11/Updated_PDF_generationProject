...
public class PdfService {
	...
	public void exportPdf(HttpServletResponse response) throws Exception {
		...
		Rectangle pageSize = new Rectangle(700, 1000);//setting the page size
...
//		doc.add(newPara);
		...
		// Define fonts for Other content
...
//		imageCell.setBorder(PdfPCell.NO_BORDER); // Remove cell border
		...
		float fixed[] = {50f,25f}; 
		PdfPTable t4 = new PdfPTable(fixed);
		...
		// Add an image to the right column
		Image img = Image.getInstance("images/banneraw.jpg");
		img.scaleAbsolute(200f, 200f);
		imageCell1.addElement(img);
		imageCell1.setPaddingRight(0f);
		imageCell1.setPaddingTop(50f);
		...
		totalAmountCell.setPaddingBottom(15f);
		...
		footerCellRight.setPaddingLeft(55f);
		footerCellRight.setPaddingBottom(13f);
		...
		addPhone.setPaddingLeft(15f);
		addPhone.setPaddingTop(9f);
		...
		float addGlobe[] = { 11f, 87f };
		PdfPTable globe = new PdfPTable(addGlobe);
		globe.setWidthPercentage(80);

		PdfPCell addingGlobe = new PdfPCell();
		Image globeIcon = Image.getInstance("images/icons8-globe-48.png");
		globeIcon.scaleAbsolute(34f, 34f);
		addingGlobe.setPaddingBottom(10f);
		addingGlobe.setPaddingLeft(10f);
